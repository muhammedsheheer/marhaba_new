    ...
    <section className="bg-menubg mt-8 flex w-full max-w-[1300px] flex-row">
      ...
      <div className="flex w-full flex-col gap-4 md:w-4/6">
        <div
          ...
          style={{
            background:
              "linear-gradient(170deg, rgba(0, 0, 0, 0.00) 7.51%, rgba(0, 0, 0, 0.80) 92.93%), url('/images/home/menu/1.png') lightgray 50% / cover no-repeat",
          }}
        >
      ...
      <div className="hidden w-2/6 flex-col md:flex">
        <div className="bg-itembackground sticky top-0 z-10 h-fit overflow-y-visible px-4 py-2">
          <div className="scrollbar-none relative flex h-[85vh] flex-col gap-6 overflow-x-auto pb-2">
            ...
            <Button
              className="bg-menuprimary font-manrope text-menuforeground hover:bg-buttonhover disabled:bg-buttondisabled disabled:text-menuforeground relative flex w-full items-center justify-between rounded-none py-6 text-lg font-bold uppercase"
