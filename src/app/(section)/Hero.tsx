...
const Hero = ({}) => {
  ...
  return (
    ...
    >
      ...
      {/* <div className="absolute right-0 top-3 hidden w-0 md:flex md:w-1/3 md:items-center md:justify-center">
        <Button
          asChild
          className="table-button z-50 flex aspect-square h-[240px] flex-col items-center justify-center rounded-full border-[2px] border-[#b58c67] bg-[#1D1D1D] px-0 py-0 text-center font-inter text-3xl font-thin uppercase text-[#b58c67] hover:bg-[#1D1D1D]"
        >
