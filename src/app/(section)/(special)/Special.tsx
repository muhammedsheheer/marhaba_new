    ...
    <section className="relative flex h-full w-full justify-center bg-primary">
      ...
      <div className="flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-4 py-12">
        <div className="flex w-full flex-col items-center justify-between gap-3 md:flex-row">
          ...
          <Button className="z-40 flex items-center justify-center gap-3 rounded-full bg-white px-6 py-7 font-playfair font-semibold uppercase text-black hover:bg-[#9c5249] hover:text-white">
            View Menu
