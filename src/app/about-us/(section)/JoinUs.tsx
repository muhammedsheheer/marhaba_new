    ...
    >
      <div className="flex h-full w-full flex-col-reverse items-center justify-center gap-4 md:flex-row">
        <div className="flex h-full w-full flex-col items-center justify-center gap-[2.5rem] p-6">
          <h1 className="font-oswald max-w-[500px] text-center text-5xl leading-[60px] text-primary">
            Gather in Harmony
            <br />
            Savor Every Moment
          </h1>
          <p className="max-w-[450px] text-center font-light leading-[160%] text-[#ffff]">
          ...
          <Button
            variant="outline"
            className="group w-fit items-center gap-[1.19rem] border-[#fff] bg-transparent font-semibold uppercase text-white hover:bg-primary"
          >
            Book Now{" "}
